...
U_CAPI void    U_EXPORT2 ucnv_setToUCallBack_4_2 (UConverter * converter,
                            UConverterToUCallback newAction,
                            const void* newContext,
                            UConverterToUCallback *oldAction,
                            const void** oldContext,
                            UErrorCode * err) {
	ucnv_setToUCallBack_44(converter, newAction, newContext,
				oldAction, oldContext, err);
}

U_CAPI void  U_EXPORT2 ucnv_close_4_2 (UConverter * converter) {
	ucnv_close (converter);
}

U_CAPI void  U_EXPORT2
ucnv_setFromUCallBack_4_2 (UConverter * converter,
                            UConverterFromUCallback newAction,
                            const void* newContext,
                            UConverterFromUCallback *oldAction,
                            const void** oldContext,
...
U_CAPI void U_EXPORT2
ucnv_convertEx_4_2(UConverter *targetCnv, UConverter *sourceCnv,
               char **target, const char *targetLimit,
               const char **source, const char *sourceLimit,
               UChar *pivotStart, UChar **pivotSource,
               UChar **pivotTarget, const UChar *pivotLimit,
...
U_CAPI UConverter* U_EXPORT2
ucnv_open_4_2 (const char *name,
                       UErrorCode * err) {
	return ucnv_open(name, err);
}

U_STABLE void U_EXPORT2 UCNV_FROM_U_CALLBACK_STOP_4_2 (
                  const void *context,
                  UConverterFromUnicodeArgs *fromUArgs,
...
U_STABLE void U_EXPORT2 UCNV_TO_U_CALLBACK_STOP_4_2 (
                  const void *context,
                  UConverterToUnicodeArgs *toUArgs,
